...
export default function Navbar() {
  return (
    <nav className="flex flex-col items-center justify-center">
      <div className="flex w-full items-center justify-center border-b-4 border-black">
        <div className="flex w-3/5 items-center justify-between py-9">
          <Image
            src="/logo_white.png"
            alt="logo"
            width="0"
      ...
      <ul className="flex w-1/2 flex-row items-center justify-center border-b border-slate-200 pt-5">
        {menus.map((e: any, i: number) => (
          <a
            key={i}
            href=""
            className="group relative h-[50px] px-10 font-semibold text-black no-underline"
          >
            {e}
